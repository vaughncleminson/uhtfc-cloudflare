/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: eaa220482c35cb505f23676378d6cf81)
// Runtime types generated with workerd@1.20260415.1 2026-01-30 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		R2: R2Bucket;
		D1: D1Database;
		ASSETS: Fetcher;
		NEXT_PUBLIC_PAYLOAD_URL: "https://uhtfc-cloudflare.vaughn-710.workers.dev/api";
		...
		NEXT_PUBLIC_MAILSEND_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_PAYLOAD_URL" | "VERCEL_PROJECT_PRODUCTION_URL" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "PAYLOAD_PUBLIC_SERVER_URL" | "NEXT_PUBLIC_MAPBOX_TOKEN" | "NEXT_PUBLIC_MAILSEND_TOKEN">> {}
}
