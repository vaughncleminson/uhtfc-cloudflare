/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: b5d03585de2aa84b48d4a28fc348dd22)
// Runtime types generated with workerd@1.20260515.1 2026-01-30 enable_nodejs_http_modules,global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	D1: D1Database;
	ASSETS: Fetcher;
	PAYLOAD_PUBLIC_SERVER_URL: "https://uhtfc.org.za";
	PAYLOAD_SECRET: string;
	NEXT_PUBLIC_PAYLOAD_URL: string;
	VERCEL_PROJECT_PRODUCTION_URL: string;
	NEXT_PUBLIC_MAPBOX_TOKEN: string;
	MAILSEND_TOKEN: string;
	MAILSEND_SHARED_WEBSITE_TEMPLATE_ID: string;
	D1_AUTO_PUSH_MIGRATIONS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_PUBLIC_SERVER_URL" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_PAYLOAD_URL" | "VERCEL_PROJECT_PRODUCTION_URL" | "NEXT_PUBLIC_MAPBOX_TOKEN" | "MAILSEND_TOKEN" | "MAILSEND_SHARED_WEBSITE_TEMPLATE_ID" | "D1_AUTO_PUSH_MIGRATIONS">> {}
}
