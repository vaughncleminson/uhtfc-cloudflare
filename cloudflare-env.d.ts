/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a92d34403fd65706f2d7ea13bed1efde)
// Runtime types generated with workerd@1.20260430.1 2026-01-30 enable_nodejs_http_modules,global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		MAILSEND_BOOKING_CONFIRMATION_TEMPLATE_ID: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "NEXT_PUBLIC_PAYLOAD_URL" | "VERCEL_PROJECT_PRODUCTION_URL" | "NEXT_PUBLIC_MAPBOX_TOKEN" | "MAILSEND_TOKEN" | "MAILSEND_BOOKING_CONFIRMATION_TEMPLATE_ID">> {}
}
